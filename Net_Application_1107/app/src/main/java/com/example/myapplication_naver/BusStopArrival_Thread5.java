...
public class BusStopArrival_Thread5 extends Thread{
    private String serviceUrl = "http://openapitraffic.daejeon.go.kr/api/rest/arrive/";
    private String function = "getArrInfoByUid";
    ...
    private ArrayList<String> busNodeIdList = new ArrayList<>();

    public BusStopArrival_Thread5(Handler handler, String data)
    {
    ...
    public void run() {
        ...
        try {
                ...
                if(eventType == XmlPullParser.START_DOCUMENT){
                    ...
                    if("0".equals(headerCd)){
                        if(bus_routeNo) {
                            ...
                            //Log.d("BusStopArrival_Thread", parser.getText());
                            busNodeIdList.add(parser.getText());
                            bus_busNodeId = false;
                        }
            ...
            bundle.putStringArrayList("BUS_NODE_ID", busNodeIdList);
